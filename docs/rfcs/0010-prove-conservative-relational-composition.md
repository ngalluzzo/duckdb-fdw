...
| Examples, diagnostics, fixtures, tests, changelog, and goal record | Affected during delivery | Add the composed SQL narrative, differential and law matrices, safe explanation, release note, workstream plans, and completion evidence | Product documentation and permanent oracles are complete; the active goal record identifies the commit-bound fresh-cell evidence still required after the implementation commit |
